...
<p class="stickies";>
<b> COUNTDOWN <font color="#0070c0">BIRTHDAY</font> </b><br>
 Birthday in <%+* let edate = moment("2024-01-06", "yyyy-MM-DD"); let from = moment().startOf('day'); edate.diff(from, "days") >= 0 ? tR += edate.diff(from, "days") : tR += edate.add(1, "year").diff(from, "days") %> days.</br> 
<!-- --- -->
</p>
